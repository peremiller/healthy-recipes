...
- **🥗 Recipe Library** — 59 unique seeded recipes with search, meal-type filters, ingredients, and steps. Twelve recipes are designed around steadier blood sugar, heart and vascular health, liver-friendly preparation, and cholesterol- and uric-acid-conscious choices. All 32 Google Calendar meal definitions are represented by 29 canonical calendar recipes; three equivalent menus are combined under aliases rather than displayed twice. Every managed recipe uses real food photography matched to its ingredients and meal type. Add / edit / delete your own recipes and optionally provide a custom photo URL.
